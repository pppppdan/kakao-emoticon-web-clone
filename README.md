...
>   * [공통 헤더 (사이드 메뉴바 제외) 및 이모티콘 검색 페이지](#공통-헤더-사이드-메뉴바-제외-및-이모티콘-검색-페이지)
>   * [인기 이모티콘 페이지](#인기-이모티콘-페이지)
>   * [이모티콘 등록 및 삭제 페이지 - 관리자](#이모티콘-등록-및-삭제-페이지---관리자)
    
  
## :round_pushpin: 프로젝트 소개  
* JSP/Servelt을 이용한 카카오 이모티콘샵 웹페이지 클론 코딩 프로젝트이며, 추가로 게시판 페이지와 이모티콘 추가/삭제할 수 있는 관리자 페이지를 구현했습니다.
...
<img width="1000" alt="스크린샷 2022-09-05 오후 1 28 42" src="https://user-images.githubusercontent.com/101396474/188360530-c9c614df-9c70-4e9d-966a-6d36cfde232f.png">


## :round_pushpin: 코드 설계
<img width="1000" alt="image" src="https://user-images.githubusercontent.com/101396474/188360254-b55aeb2d-336f-4539-8a39-bce6696c5b6d.png">  
